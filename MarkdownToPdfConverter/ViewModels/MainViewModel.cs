...
namespace MarkdownToPdfConverter.ViewModels
{
    public class MainViewModel : ReactiveObject
    {
        ...
        private string _theme = "Gray";
        private string _background = "#2E2E2E";
        private string _foreground = "#D0D0D0";
        private string _borderBrush = "#444444";
        private string _textBoxBackground = "#333333";
        private string _textBoxForeground = "#D0D0D0";
